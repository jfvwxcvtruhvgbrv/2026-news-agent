...
.field b{display:block;font-size:13px;letter-spacing:.04em;color:#B43B2E;margin-bottom:7px;font-weight:700}
...
def build_site():
    ...
    for path in archive_files:
        ...
        gen_time = data.get("time")  # 실제 KST 생성 시각(HH:MM). 예전 아카이브엔 없을 수 있다.
        session_suffix = f" · {gen_time}" if gen_time else ""
